...
public class LivreAdapter extends RecyclerView.Adapter<LivreAdapter.LivreViewHolder>
    ...
    public LivreAdapter(ArrayList < Livre > listeLivres) {
        ...
        @NonNull
        @Override
        public LivreViewHolder onCreateViewHolder (
        ...
        public void onBindViewHolder (
            @NonNull LivreViewHolder holder,
        int position){

        Livre livre = listeLivres.get(position);

        holder.tvTitreLivre.setText(livre.getTitre());
        holder.tvAuteurLivre.setText(
                "Auteur : " + livre.getAuteur());

        holder.tvIsbnLivre.setText(
                "ISBN : " + livre.getIsbn());
        ...
        if (livre.isDisponible()) {
            ...
            holder.tvDisponibilite.setBackgroundColor(
        ...
        public static class LivreViewHolder
            ...
            public LivreViewHolder(@NonNull View itemView) {
                ...
                tvTitreLivre =
                        itemView.findViewById(R.id.tvTitreLivre);

                tvAuteurLivre =
                        itemView.findViewById(R.id.tvAuteurLivre);

                tvIsbnLivre =
                        itemView.findViewById(R.id.tvIsbnLivre);
